...
// Ýki boyuttan daha büyük diziler de benzer þekilde indirgenebilir. Üç boyutlu bir dizi, iki boyutlu bir diziyi gösteren bir iþaretçiye indirgenebilir. Bu da, tek boyutlu
// bir diziyi gösteren bir iþaretçiye indirgenebilir. Genel olarak, n boyutlu bir dizi, bir iþaretçi ve (n-1) boyutlu bir diziye indirgenebilir. Bu yeni dizi de yine ayný
// yöntemle azaltýlabilir. Bu süreç, tek boyutlu bir dizi üretildiðinde sona erer.
